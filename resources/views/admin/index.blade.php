                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="list d-flex align-items-center border-bottom pb-3">
                                        <img class="img-sm rounded-circle" src="source2/www.urbanui.com/serein/template/images/faces/face8.jpg" alt="">
                                    ...
                                    <div class="list d-flex align-items-center border-bottom py-3">
                                        <img class="img-sm rounded-circle" src="source2/www.urbanui.com/serein/template/images/faces/face5.jpg" alt="">
                                        <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="list d-flex align-items-center border-bottom py-3">
                                        <img class="img-sm rounded-circle" src="source2/www.urbanui.com/serein/template/images/faces/face7.jpg" alt="">
                                        <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="list d-flex align-items-center border-bottom py-3">
                                        <img class="img-sm rounded-circle" src="source2/www.urbanui.com/serein/template/images/faces/face6.jpg" alt="">
                                        <div class="wrapper w-100 ml-3">
                                    ...
                                    <div class="list d-flex align-items-center pt-3">
                                        <img class="img-sm rounded-circle" src="source2/www.urbanui.com/serein/template/images/faces/face9.jpg" alt="">
                                        <div class="wrapper w-100 ml-3">
